...
{{--<!-- Mirrored from www.codecovers.eu/materialadmin/forms/wizard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2017 07:26:56 GMT -->--}}
...
{{--<head>--}}
    ...
    {{--<link type="text/css" rel="stylesheet" href="/css/modules/materialadmin/css/theme-default/bootstrap94be.css?1422823238" />--}}

    {{--<link type="text/css" rel="stylesheet" href="./css/modules/materialadmin/css/theme-default/materialadminb0e2.css?1422823243" />--}}

    {{--<link type="text/css" rel="stylesheet" href="/css/modules/materialadmin/css/theme-default/font-awesome.min753e.css?1422823239" />--}}

    {{--<link type="text/css" rel="stylesheet" href="/css/modules/materialadmin/css/theme-default/material-design-iconic-font.mine7ea.css?1422823240" />--}}


    {{--<link type="text/css" rel="stylesheet" href="/css/modules/materialadmin/css/theme-default/libs/wizard/wizardfa6c.css?1422823375" />--}}
            ...
            {{--<ul class="header-nav header-nav-profile">--}}
                {{--<li class="dropdown">--}}
                    ...
                    {{--<ul class="dropdown-menu animation-dock">--}}
                        ...
                        {{--<li><a href="http://www.codecovers.eu/materialadmin/pages/blog/post"><span class="badge style-danger pull-right">16</span>My blog</a></li>--}}
                        {{--<li><a href="http://www.codecovers.eu/materialadmin/pages/calendar">My appointments</a></li>--}}
                        {{--<li class="divider"></li>--}}
                        {{--<li><a href="http://www.codecovers.eu/materialadmin/pages/locked"><i class="fa fa-fw fa-lock"></i> Lock</a></li>--}}
                        {{--<li><a href="http://www.codecovers.eu/materialadmin/pages/login"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>--}}
                    {{--</ul><!--end .dropdown-menu -->--}}
                {{--</li><!--end .dropdown -->--}}
    ...
    {{--<div id="content">--}}
        {{--<section>--}}
            ...
            {{--<div class="section-body contain-lg">--}}
                ...
                {{--<div class="row">--}}
                    {{--<div class="col-lg-12">--}}
                        {{--<h1 class="text-primary">Form wizard</h1>--}}
                    {{--</div><!--end .col -->--}}
                    {{--<div class="col-lg-8">--}}
                                    ...
                                    {{--<form class="form floating-label">--}}
                                        {{--<div class="form-wizard-nav">--}}
                                            ...
                                            {{--<ul class="nav nav-justified">--}}
                                                ...
                                                {{--<li><a href="#tab3" data-toggle="tab"><span class="step">3</span> <span class="title">SETTINGS</span></a></li>--}}
        ...
        {{--<div class="menubar-scroll-panel">--}}
            ...
            {{--<ul id="main-menu" class="gui-controls">--}}
                ...
                {{--<li class="gui-folder">--}}
                    ...
                    {{--<!--start submenu -->--}}
                    {{--<ul>--}}
                        {{--<li><a href="basic.html" ><span class="title">Form basic</span></a></li>--}}

                        {{--<li><a href="advanced.html" ><span class="title">Form advanced</span></a></li>--}}

                        {{--<li><a href="layouts.html" ><span class="title">Form layouts</span></a></li>--}}

                        {{--<li><a href="editors.html" ><span class="title">Editors</span></a></li>--}}

                        {{--<li><a href="validation.html" ><span class="title">Form validation</span></a></li>--}}

                        {{--<li><a href="wizard.html" class="active"><span class="title">Form wizard</span></a></li>--}}
...
{{--<script src="/js/modules/materialadmin/libs/jquery-validation/dist/jquery.validate.min.js"></script>--}}
{{--<script src="/js/modules/materialadmin/libs/jquery-validation/dist/additional-methods.min.js"></script>--}}
{{--<script src="/js/modules/materialadmin/libs/wizard/jquery.bootstrap.wizard.min.js"></script>--}}
...
{{--<script src="/js/modules/materialadmin/core/demo/DemoFormWizard.js"></script>--}}
...
{{--<!-- Mirrored from www.codecovers.eu/materialadmin/forms/wizard by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2017 07:26:58 GMT -->--}}
{{--</html>--}}